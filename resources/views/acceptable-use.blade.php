...
<div id="p_lt_ctl01_sys_pnlUpdate">
    ...
    <div class="container">
        <div class="lipsum elements">
            <p>This acceptable use policy sets out the terms between you and us under which you may access our
                websites www.womenonboards.net/en-au/ and https://community.womenonboards.net/ (our sites) and
                his acceptable use policy applies to all users of, and visitors to, our sites.</p>

            <p>Your use of our sites means that you accept, and agree to abide by, all the policies in this
                acceptable use policy, which supplement our terms of website use.</p>

            <p>Our sites are&nbsp;operated by Women on Boards Australia Pty Ltd (we or us).&nbsp; We are
                registered in Australia ABN number 72 135 991 810 and we have our registered office at Shop 6,
                107-109 Mann Street Gosford NSW 2250 Australia. Our main trading address is the same as our
            ...
            <ul>
                ...
                <li>To send, knowingly receive, upload, download, use or re-use any material which does not
                    comply with our content standards (below).</li>
            ...
            <h3><strong>INTERACTIVE SERVICES</strong></h3>
            ...
            <p>Where we do provide any interactive service, we will provide clear information to you about the
                kind of service offered, if it is moderated and what form of moderation is used (including
                whether it is human or technical).</p>

            <div>We will do our best to assess any possible risks for users (and in particular, for children)
                from third parties when they use any interactive service provided on our site, and we will
                ...
                obligation to oversee, monitor or moderate any interactive service we provide on our site, and
                we expressly exclude our liability for any loss or damage arising from the use of any
                interactive service by a user in contravention of our content standards, whether the service is
                moderated or not.<br />
                &nbsp;</div>

            <p>The use of any of our interactive services by a minor is subject to the consent of their parent
                ...
                is not foolproof. Minors who are using any interactive service should be made aware of the
                potential risks to them.</p>

            <p>Where we do moderate an interactive service, we will normally provide you with a means of
                contacting the moderator, should a concern or difficulty arise.</p>

            <h3><strong>CONTENT STANDARDS</strong></h3>

            <p>These content standards apply to any and all material which you contribute to our site
                (contributions), and to any interactive services associated with it.</p>

            <p>You must comply with the spirit of the following standards as well as the letter. The standards
            ...
            <ul>
                ...
                <li>Comply with applicable law in Australia and in any country from which they are posted.</li>
            </ul>
            ...
            <ul>
                ...
                <li>Be made in breach of any legal duty owed to a third party, such as a contractual duty or a
                    duty of confidence.</li>
                <li>Promote any illegal activity.</li>
                <li>Be threatening, abuse or invade another&rsquo;s privacy, or cause annoyance, inconvenience
            ...
            <p>We will determine, in our discretion, whether there has been a breach of this acceptable use
                policy through your use of our site.&nbsp; When a breach of this policy has occurred, we may
                take such action as we deem appropriate. &nbsp;</p>

            <p>Failure to comply with this acceptable use policy constitutes a material breach of the terms of
            ...
            <ul>
                ...
                <li>Immediate, temporary or permanent removal of any posting or material uploaded by you to our
                    site.</li>
            ...
            <p>We exclude liability for actions taken in response to breaches of this acceptable use
                policy.&nbsp; The responses described in this policy are not limited, and we may take any other
                action we reasonably deem appropriate.</p>

            <h3><strong>CHANGES TO THE ACCEPTABLE USE POLICY</strong></h3>

            <p>We may revise this acceptable use policy at any time by amending this page. You are expected to
                ...
                superseded by provisions or notices published elsewhere on our site.</p>
                </div>
                </div>
